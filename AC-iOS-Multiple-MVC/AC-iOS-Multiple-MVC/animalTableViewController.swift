...
class animalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let animalInfo = animalData[indexPath.row]
        cell.animalLabelOutlet.text = animalInfo.name
        cell.originLabelOutlet.text = animalInfo.origin
        cell.animalImageView.image = UIImage(named: String(animalInfo.imageNumber))
        // Configure the cell...
